...
class GradCAM:
    def __init__(self, model, feature_layer):
        ...
        self.handlers = []  # Store hook handlers
        self.handlers.append(feature_layer.register_forward_hook(self.save_feature_maps))
        self.handlers.append(feature_layer.register_backward_hook(self.save_gradients))

    def save_gradients(self, module, grad_input, grad_output):
        # grad_output contains the gradient flowing out of the feature_layer
        self.gradients = grad_output[0]

    def save_feature_maps(self, module, input, output):
        # output is the feature maps generated by the forward pass through the feature_layer
